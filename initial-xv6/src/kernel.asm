...
8010403b:	68 57 78 10 80       	push   $0x80107857
...
801049e4:	68 34 76 10 80       	push   $0x80107634
...
801049fc:	68 33 76 10 80       	push   $0x80107633
...
80104a15:	68 27 76 10 80       	push   $0x80107627
...
80104a2a:	68 36 76 10 80       	push   $0x80107636
80104a2f:	e8 5c b9 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104a34:	83 ec 0c             	sub    $0xc,%esp
80104a37:	68 18 76 10 80       	push   $0x80107618
...
80104e39:	58                   	pop    %eax
80104e3a:	5a                   	pop    %edx
80104e3b:	68 34 76 10 80       	push   $0x80107634
...
80104e54:	68 33 76 10 80       	push   $0x80107633
...
80105687:	c7 04 c5 c2 4c 11 80 	movl   $0x8e000008,-0x7feeb33e(,%eax,8)
8010568e:	08 00 00 8e 
80105692:	66 89 14 c5 c0 4c 11 	mov    %dx,-0x7feeb340(,%eax,8)
80105699:	80 
8010569a:	c1 ea 10             	shr    $0x10,%edx
8010569d:	66 89 14 c5 c6 4c 11 	mov    %dx,-0x7feeb33a(,%eax,8)
801056a4:	80 
  for(i = 0; i < 256; i++)
...
801056b4:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801056b7:	c7 05 c2 4e 11 80 08 	movl   $0xef000008,0x80114ec2
801056be:	00 00 ef 
  initlock(&tickslock, "time");
801056c1:	68 79 76 10 80       	push   $0x80107679
801056c6:	68 80 4c 11 80       	push   $0x80114c80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801056cb:	66 a3 c0 4e 11 80    	mov    %ax,0x80114ec0
801056d1:	c1 e8 10             	shr    $0x10,%eax
801056d4:	66 a3 c6 4e 11 80    	mov    %ax,0x80114ec6
  initlock(&tickslock, "time");
...
801058e7:	68 84 76 10 80       	push   $0x80107684
...
80105a8c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105a8f:	bb a0 77 10 80       	mov    $0x801077a0,%ebx
  ioapicenable(IRQ_COM1, 0);
...
8010669d:	68 a8 77 10 80       	push   $0x801077a8
...
8010676a:	c7 80 18 28 11 80 ff 	movl   $0xffff,-0x7feed7e8(%eax)
80106771:	ff 00 00 
80106774:	c7 80 1c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7e4(%eax)
8010677b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010677e:	c7 80 20 28 11 80 ff 	movl   $0xffff,-0x7feed7e0(%eax)
80106785:	ff 00 00 
80106788:	c7 80 24 28 11 80 00 	movl   $0xcf9200,-0x7feed7dc(%eax)
8010678f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106792:	c7 80 28 28 11 80 ff 	movl   $0xffff,-0x7feed7d8(%eax)
80106799:	ff 00 00 
8010679c:	c7 80 2c 28 11 80 00 	movl   $0xcffa00,-0x7feed7d4(%eax)
801067a3:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801067a6:	c7 80 30 28 11 80 ff 	movl   $0xffff,-0x7feed7d0(%eax)
801067ad:	ff 00 00 
801067b0:	c7 80 34 28 11 80 00 	movl   $0xcff200,-0x7feed7cc(%eax)
801067b7:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
801067ba:	05 10 28 11 80       	add    $0x80112810,%eax
  pd[1] = (uint)p;
...
801067e0:	a1 c4 54 11 80       	mov    0x801154c4,%eax
{
...
80106979:	68 ed 77 10 80       	push   $0x801077ed
...
80106add:	68 25 78 10 80       	push   $0x80107825
...
80106b13:	68 3d 78 10 80       	push   $0x8010783d
...
80106c1c:	68 59 78 10 80       	push   $0x80107859
...
80106cef:	68 6a 78 10 80       	push   $0x8010786a
...
80106dd9:	68 8e 78 10 80       	push   $0x8010788e
80106dde:	e8 ad 95 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106de3:	83 ec 0c             	sub    $0xc,%esp
80106de6:	68 74 78 10 80       	push   $0x80107874
